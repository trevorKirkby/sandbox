...
HillsofSparrows = SEE.mkdir('HillsOfTheSparrows',"A sprawling area of hills covered in vegetation and several buildings. The buildings are vaguely oriental")


Docks = SEE.mkdir('Docks',"A small docks and town at the side of albatross lake. In the center, an island is visible through the fog.")
...
GatewayRepublic = SEE.mkdir('GatewayRepublic',"A curious area filled with artificial intelligence possessing doors. These doors have formed their own sophisticated government, building a prosperous country. The area is rumored to have suffered some programming errors in the recent past...")
...
BarrowOfTrensildor = SEE.mkdir('BarrowOfTrensildor',"A massive stone monolith full of large spire monuments... and maybe some rogue programs.")


RealmOfTheRadioActiveRodents = SEE.mkdir('DangerRadioactivity',"A sign read: Warning. The indigenous population are highly radioactive. Prepare yourself.")
...
ScorchedStandardValley = SEE.mkdir('ScorchedValley',"Below lies a huge valley full of swirling snow and fog. In the distance a damaged looking camp lies at the center of the valley.")


RiverNight = SEE.mkdir('RiverNight',"This is the river of night. If you don't know what that is you'll find out pretty soon.")


HouseOfInsults = SEE.mkdir('HouseOfRubberBands',"You'll have to work out the reason for the name to get an easter egg here... It may make sense eventually, just think about the prevalent force in this 'house'. Speaking of that, you are no longer on the river of night, as you got somewhat sidetracked...")
...
StepL = StepK.mkdir('StoneStep',"Graffiti etches on the steps depict a clock strapped to a huge computer with lots of wires leading from it. The computer has an eye drawn into it's screen. There is also an elephant carrying a flagpole.")
...
StepV = StepU.mkdir('StoneStep',"Still foggy. Weird shapes are visible in the fog.")
StepW = StepV.mkdir('StoneStep',"Another flash of steel is visible not too far up.")
...
#PLATFORM 3
Platform4 = Platform3.mkdir("Ramp","Hello, this is a challenge help sign. Here is the advice: try not to lose...")
...
Chest2 = ex.chest2()
noobPkg.add(Chest2)
Stairway = noobPkg.mkdir('Stairway','You are on a stairway upward and all... ... ... ... ...What else do you even want to know? ...  ... There is not anything else! You can go now! bye.')
